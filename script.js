...
function projectVisual(project){
  return `<div class="project-visual"><div class="project-visual-inner"><span class="mini-label">${project.visual}</span><div class="mini-metrics">${project.metrics.slice(0,3).map(m=>`<span class="mini-metric">${m}</span>`).join('')}</div></div></div>`;
}
